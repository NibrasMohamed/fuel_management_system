                    ...
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            ...
                            <form id="token_request_form" data-parsley-validate="" class="form-horizontal form-label-left"
                                ...
                                <div class="item form-group">
                                    <label class="col-form-label col-md-3 col-sm-3 label-align" for="name">Customer Name
                                    </label>
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="text" id="name" required="required"
                                            value="{{ $token->customer->name }}" class="form-control" name="name"
                                            disabled>
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <input type="time" id="time" name="time" class="form-control"
                                            value="{{ $token->expected_time }}" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 ">
                                        <div class="input-group">
                                            <input type="number" value="{{ $token->fuel_quantity }}" id="request-fuel"
                                                name="request-fuel" required="required" class="form-control" disabled>
                                            <div class="input-group-append">
                                ...
                                <div class="item form-group text-center">
                                    <div class="col-md-6 col-sm-6 offset-md-3">
                                        ...
                                        <button type="submit" class="btn btn-success submit-btn">Make Payment</button>
                                    </div>
                                </div>
                                {{-- <div class="item form-group">
